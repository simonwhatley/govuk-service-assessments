...
Run a [retrospective](/version-1/guides/running-retrospectives/) at the end of each delivery cycle or [sprint](/version-1/features-of-agile/) to review what worked or what could be improved.
...
- product manager – (a role probably performed by the [Service manager](/version-1/guides/service-manager/)) responsible for delivering return on investment, usually by creating products that users love
- [delivery manager](/version-1/guides/delivery-manager/) (aka Scrum master or project manager) – the agile expert responsible for removing blockers (things slowing a team down), they also act as a facilitator at team meetings
- [team members](/version-1/guides/the-team/) – self-organising and multi-disciplinary, they produce user stories, carry out the product manager’s vision and are responsible for estimating their output and speed
