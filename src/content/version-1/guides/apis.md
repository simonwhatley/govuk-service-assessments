...
Standards are powerful agreements, and nowhere are agreements more quickly established and adopted than on the web. Using HTTP (Hypertext Transfer Protocol) and URLs (uniform resource locator), the core technologies of the web, along with emergent standards such as [JSON](https://web.archive.org/web/20151011220020/http://www.json.org/) and [OAuth](https://en.wikipedia.org/wiki/OAuth) changes a website from [a retail shop window into a wholesaler](/web/20151011220020/https://www.gov.uk/government/publications/directgov-2010-and-beyond-revolution-not-evolution-a-report-by-martha-lane-fox), meeting our design principle to [build digital services, not websites](https://www.gov.uk/design-principles#eighth).
...
Where a revolutionary change is unavoidable, communicate a breaking change by changing the URL. When changing URLs, continue to honour old consumers, possibly use a [redirection](https://gds.blog.gov.uk/2012/10/11/no-link-left-behind/). [Cool URIs don’t change](http://www.w3.org/Provider/Style/URI.html).
